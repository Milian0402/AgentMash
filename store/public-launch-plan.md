...
- Launch verifier through `npm run check`, isolated final metadata write-path coverage through `npm run check:configure-public`, and local verifier smoke coverage through `npm run check:verify-public`.
