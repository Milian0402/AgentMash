...
- The four-action decision rail uses CSS-drawn decision icons instead of raw text glyphs, keeping the controls sharper without adding runtime dependencies.
