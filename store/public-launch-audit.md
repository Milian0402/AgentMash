...
Playwright CLI and `npm run ready:public` checked `http://127.0.0.1:5177` and the local `_site/` package on May 8, 2026 after the `v0.3.0` launch-prep build label and `agentmash-v44` service-worker cache update.
